...
// Asegura la existencia de la sesión y el rol de usuario
if (isset($_SESSION['Rol_Usuario'])) {
    // Define el directorio de los archivos de menú
    $directorioMenu = "Menus/";
    ...
    if (array_key_exists($_SESSION['Rol_Usuario'], $archivosMenu)) {
        // Incluye el archivo de menú correspondiente
        require($directorioMenu . $archivosMenu[$_SESSION['Rol_Usuario']]);
        require("Php/Conexion.php");
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <title>Registro de Pedidos de Productos</title>
    <meta charset="UTF-8">
...
<body>
    <div class="Contenedor_login">
        <h1>REGISTRO DE PEDIDOS DE PRODUCTOS</h1>
        <form method="post" enctype="multipart/form-data" action="Php/insertar_entrada.php">
            ...
            <button class="btn_login" name="Registrar Entrada">Registrar Entrada</button>
        </form>
    </div>
    <!-- ========== Mostrar Alertas =========== -->
