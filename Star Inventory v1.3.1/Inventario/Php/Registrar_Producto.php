...
if (isset($_SESSION['Rol_Usuario']) && $_SESSION['Rol_Usuario']) {
    ...
    if (isset($_POST['Enviar'])) {
        ...
        if (
            ...
            $stmtVerificacion = mysqli_prepare($CONEXION, "SELECT * FROM producto WHERE Nombre_Producto= ?");
            ...
            if (mysqli_stmt_num_rows($stmtVerificacion) > 0) {
                agregarToast('error', 'Error', '¡Este producto ya existe!');
            } else {
                ...
                agregarToast('exito', 'Éxito', '¡Producto registrado exitosamente!');
            }
        } else {
