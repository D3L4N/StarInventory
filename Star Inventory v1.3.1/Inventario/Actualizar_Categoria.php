...
?>
     ...
     <!-- ========== Boton regresar =========== -->
    <button class="regresar"><a href="Crud_Categorias.php">Cancelar Edición</a></button>
    <!-- ========== Formulario =========== -->
